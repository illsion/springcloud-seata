...
public class RequestContextThreadChange extends HystrixConcurrencyStrategy {


    private final Collection<HystrixCallableWrapper> wrappers;
    public RequestContextThreadChange(Collection<HystrixCallableWrapper> wrappers) {
